...
/// </remarks>
[Serializable]
public class ComicPage : ISerializationCallbackReceiver
{
    ...
    public bool IsCustomSizeImage
    {
        get
        {
            return _imageDisplayMode == ComicPage.ImageDisplayModes.CustomSize;
        }
    }
    ...
    public bool IsFullscreenImage
    {
        get
        {
            return _imageDisplayMode == ComicPage.ImageDisplayModes.StretchFullScreen;
        }
    }
