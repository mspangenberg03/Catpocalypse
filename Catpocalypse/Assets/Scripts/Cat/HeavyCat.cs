...
public class HeavyCat : MonoBehaviour
{
    public static event EventHandler OnCatDied;


    private int distraction = 0; //How distracted the cat is currently
    private int distractionThreshold = 75; //The amount of distraction it takes to fully distract the cat
    ...
    private float damageToPlayer = 3f; //How much health the cat takes from the player
